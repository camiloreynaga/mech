...
Public Class MantOrdenDesembolsoForm2
    ...
    Private Sub MantOrdenDesembolsoForm2_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub
    ...
    Private Sub MantOrdenDesembolsoForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtSer.Text = vSSerie
        sele = "select idOP,nroDes,serie,nro,fecDes,simbolo,monto,montoDet,montoDif,banco,nroCta,est,nroDet,datoReq,hist,estado,codigo,codIde,factCheck,bolCheck,guiaCheck,vouCheck,vouDCheck,reciCheck,otroCheck,descOtro,nroConfor,fecEnt,codMon,codSerO,vanCaja from VOrdenDesembolso1 where codSerO=@ser" 'order by nroDes"
        ...
        Try
            ...
            BindingSource3.DataMember = "VOrdenDesembolso1"
    ...
    Private Sub MantOrdenDesembolsoForm2_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    ...
    Private Sub calcularTotales()
        ...
        End If
        Try
            txtTotal.Text = Format(dsAlmacen.Tables("VOrdenDesembolso1").Compute("Sum(monto)", "codMon=30"), "0,0.00")  '30=soles
            txtTotal1.Text = Format(dsAlmacen.Tables("VOrdenDesembolso1").Compute("Sum(monto)", "codMon=35"), "0,0.00")  '35=dolares
            txtTotal2.Text = Format(dsAlmacen.Tables("VOrdenDesembolso1").Compute("Sum(montoDet)", "codMon=30"), "0,0.00")  '30=soles
            txtTotal3.Text = Format(dsAlmacen.Tables("VOrdenDesembolso1").Compute("Sum(montoDet)", "codMon=35"), "0,0.00")  '35=dolares
    ...
    Private Sub txtBuscar_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBuscar.TextChanged
        BindingSource1.Filter = "razon like '" & txtBuscar.Text.Trim() & "%'"
    ...
    Private Sub enlazarText()
        If vfVan2 Then
            ...
            Else
                ...
                'cbSubClas.FindStringExact(BindingSource1.Item(BindingSource1.Position)(2))
                Dim codCla As Integer = recuperarCodCla(BindingSource3.Item(BindingSource3.Position)(30))
                ...
                Else    'ubicar en clasificacion
                    ...
                    cbSubClas.SelectedValue = BindingSource3.Item(BindingSource3.Position)(30) 'codTipCla
                End If
    ...
    Private Sub btnF1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            dsAlmacen.Tables("VOrdenDesembolso1").Clear()
            daTabla1.Fill(dsAlmacen, "VOrdenDesembolso1")
    ...
    Private Sub comandoInsert1()
        ...
        cmInserTable1.Parameters.Add("@van", SqlDbType.Int, 0).Value = cbSubClas.SelectedValue
    ...
    Private Sub comandoUpdate1()
        ...
        cmUpdateTable1.CommandText = "update TOrdenDesembolso set codMon=@codMon,monto=@mon,montoDet=@mon1,montoDif=@mon2,codigo=@cod,codIde=@codIde,banco=@ban,nroCta=@nroC,nroDet=@nroDE,datoReq=@dato,factCheck=@fact,bolCheck=@bol,guiaCheck=@guia,vouCheck=@vou,vouDCheck=@vouD,reciCheck=@reci,otroCheck=@otro,descOtro=@des,hist=@hist,vanCaja=@van where idOP=@idOP"
        ...
        cmUpdateTable1.Parameters.Add("@van", SqlDbType.Int, 0).Value = cbSubClas.SelectedValue
    ...
    Private Sub comandoUpdate11()
        ...
        cmUpdateTable11.CommandText = "update TOrdenDesembolso set banco=@ban,nroCta=@nroC,nroDet=@nroDE,datoReq=@dato,factCheck=@fact,bolCheck=@bol,guiaCheck=@guia,vouCheck=@vou,vouDCheck=@vouD,reciCheck=@reci,otroCheck=@otro,descOtro=@des,hist=@hist,vanCaja=@van where idOP=@idOP"
        ...
        cmUpdateTable11.Parameters.Add("@van", SqlDbType.Int, 0).Value = cbSubClas.SelectedValue
