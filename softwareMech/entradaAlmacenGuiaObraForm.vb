...
Public Class entradaAlmacenGuiaObraForm
    Dim BindingSource1 As New BindingSource
    Dim BindingSource2 As New BindingSource
    Dim BindingSource4 As New BindingSource
    Dim BindingSource11 As New BindingSource

    Private Sub entradaAlmacenGuiaObraForm_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub

    Private Sub entradaAlmacenGuiaObraForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select codGuiaE,fecIni,nro,razon,ruc,partida,llegada,motivo,nroFact,nomPers,empTra,rucTra,marcaNro,nroConst,nroLic,nomTra,DNI,obs,hist,talon,nroGuia,codVeh,codT,codMotG,codPers,codObraOri,codObraDes,codET,codSerS,codIde,codUbiOri,codUbiDes from VGuiaRemEmpEnt where codObraDes=@cod"
        ...
        Try
            ...
            txtUbi.DataBindings.Add("Text", BindingSource4, "almObra")
            txtObra.DataBindings.Add("Text", BindingSource4, "nomObraDes")
    ...
    Private Sub entradaAlmacenGuiaObraForm_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    ...
    Private Sub ModificarColumnasDGV()
        ...
        With dgTabla3
            ...
            .Columns(6).Width = 60
            .Columns(6).HeaderText = "Entregado"
    ...
    Private Sub btnDes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDes.Click
        ...
        If BindingSource4.Item(BindingSource4.Position)(26) = 3 And BindingSource4.Item(BindingSource4.Position)(24) = BindingSource2.Item(BindingSource2.Position)(0) Then  'Salida Mech >0 con guia
        Else
            MessageBox.Show("Proceso denegado, Movimiento NO es proceso de ENTRADA con la misma Guia...", nomNegocio, Nothing, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub visualizarKardex()
        ...
        daVKardex.SelectCommand.Parameters("@codUbi").Value = BindingSource1.Item(BindingSource1.Position)(31)
        daVKardex.Fill(dsAlmacen, "VKardex1")
        colorear()
    ...
    Private Sub btnPro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPro.Click
        ...
        Try
            ...
            If existe = 0 Then 'No existe stock crear...
                'TMatUbi
                comandoInsert1(BindingSource2.Item(BindingSource2.Position)(9), BindingSource1.Item(BindingSource1.Position)(31), CDbl(BindingSource2.Item(BindingSource2.Position)(2)))
            ...
            'TEntradaSalida
            comandoInsert2(Now.Date, BindingSource2.Item(BindingSource2.Position)(9), idMU, BindingSource1.Item(BindingSource1.Position)(31), cantEnt, precio, cantSal, 0, BindingSource2.Item(BindingSource2.Position)(0), "R " & BindingSource1.Item(BindingSource1.Position)(2), 0, BindingSource1.Item(BindingSource1.Position)(8), "", 3, vPass, vPass, "", codSal, BindingSource1.Item(BindingSource1.Position)(31), 1, BindingSource1.Item(BindingSource1.Position)(29)) '3=Entrada con guia MECH 1=recibido
