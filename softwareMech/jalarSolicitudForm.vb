...
Public Class jalarSolicitudForm
    ...
    Private Sub jalarSolicitudForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Cursor = Cursors.WaitCursor
        VerificaConexion()
        Dim wait As New waitForm
        wait.Show()
        'instanciando los dataAdapter con sus comandos select - DatasetAlmacenModule.vb
        Dim sele As String = "select idSol,nroS,nro,fecSol,nroCotiConca,nombres,obs,est,lugar,codigo,codPers,estado from VSolTodoCad where codigo=@cod"
    ...
    Private Sub ModificarColumnasDGV()
        With dgTabla1
            ...
            .Columns(3).Width = 70
            .Columns(4).Width = 90
            .Columns(4).HeaderText = "Relac.Cotiz."
    ...
    Private Sub ToolStripButton6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton6.Click
        ...
        Dim resp As String = MessageBox.Show("Esta segúro de agregar requerimientos" & Chr(13) & " a solicitud Nº " & vCod1, nomNegocio, MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If resp <> 6 Then
            Exit Sub
        End If
        ...
        Try
            ...
            For j As Short = 0 To bindingSource5.Count - 1
                ...
                If bindingSource5.Item(j)(17) = True Then 'solo los Check  
                    'TDetalleCot
                    comandoInsert1(bindingSource5.Item(j)(2), bindingSource5.Item(j)(3), bindingSource5.Item(j)(4), vNroOrden, bindingSource5.Item(j)(12))
    ...
    Private Sub comandoInsert1(ByVal cant As Decimal, ByVal uni As String, ByVal des As String, ByVal codCot As Integer, ByVal codmat As Integer)
        ...
        cmInserTable1.Parameters.Add("@codC", SqlDbType.Int, 0).Value = codCot
