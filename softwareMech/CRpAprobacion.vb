...
Public Class CRpAprobacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "softwareMech.CRpAprobacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRpAprobacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRpAprobacion = New CRpAprobacion
        rpt.Site = Me.Site
        Return rpt
    End Function
