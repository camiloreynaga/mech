...
Public Class MantUniMedForm
    'Instanciar una tabla de datos en memoria en ves de dataSet
    Dim dataTable1 As New DataTable()
    Dim BindingSource1 As New BindingSource

    Private Sub MantUniMedForm_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub

    Private Sub MantUniMedForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select codUni,unidad from TUnidad where codUni>1 order by unidad"
        ...
        Try
            ...
            lbTabla1.DisplayMember = "unidad"
            lbTabla1.ValueMember = "codUni"
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        If BindingSource1.Find("unidad", txtCam.Text.Trim()) >= 0 Then
            MessageBox.Show("Ya exíste unidad de medida: " & txtCam.Text.Trim() & Chr(13) & "Cambie de nombre o cancele el proceso...", nomNegocio, Nothing, MessageBoxIcon.Information)
            txtCam.Focus()
            txtCam.SelectAll()
            Exit Sub
        End If
        ...
        Try
            ...
            BindingSource1.Position = BindingSource1.Find("unidad", campo)
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        ...
        If vfCampo.ToUpper() <> txtCam.Text.ToUpper().Trim() Then
            ...
            End If
        End If
        Dim resp As String = MessageBox.Show("Esta segúro de actualizar unidad de medida... ?" & Chr(13) & "Si actualiza todas sus dependencias heredaran" & Chr(13) & "este nombre...", nomNegocio, MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If resp <> 6 Then
            txtCam.Focus()
            Exit Sub
        End If
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If recuperarCount1(lbTabla1.SelectedValue) > 0 Then
            StatusBarClass.messageBarraEstado(" Proceso denegado, unidad de medida tiene materiales base...")
            Exit Sub
        End If
    ...
    Private Sub comandoInsert()
        ...
        cmInserTable.CommandText = "insert into TUnidad(unidad) values(@cam)"
    ...
    Private Sub comandoUpdate()
        ...
        cmUpdateTable.CommandText = "update TUnidad set unidad=@cam where codUni=@cod"
    ...
    Private Sub comandoDelete()
        ...
        cmDeleteTable.CommandText = "delete from TUnidad where codUni=@cod"
