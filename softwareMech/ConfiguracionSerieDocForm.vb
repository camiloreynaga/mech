...
Public Class ConfiguracionSerieDocForm
    Dim BindingSource2 As New BindingSource

    Private Sub ConfiguracionSerieDocForm_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub

    Private Sub ConfiguracionSerieDocForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select codSerO,serie,iniNroDoc,'est'=case when estado=1 then 'Activo' else 'INACTIVO' end,descrip,estado from TSerieOrden order by serie"
        ...
        Try
            ...
            daTabla2.Fill(dsAlmacen, "TSerieOrden")

            BindingSource2.DataSource = dsAlmacen
            BindingSource2.DataMember = "TSerieOrden"
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        ...
        Else    'Actualizar
            ...
            Try
                ...
                Dim j As Short = BindingSource2.Find("codSerO", vfCampo1)
    ...
    Private Sub comandoInsert()
        ...
        cmInserTable.CommandText = "insert into TSerieOrden(serie,iniNroDoc,descrip,estado) values(@ser,@ini,@des,@est)"
    ...
    Private Sub comandoUpdate()
        ...
        cmUpdateTable.CommandText = "update TSerieOrden set serie=@var,iniNroDoc=@var1,descrip=@var3,estado=@var4 where codSerO=@cod"
    ...
    Private Sub comandoDelete()
        ...
        cmDeleteTable.CommandText = "delete from TSerieOrden where codSerO=@cod"
