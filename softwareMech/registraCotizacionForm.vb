...
Public Class registraCotizacionForm
    ...
    Private Sub registraCotizacionForm_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub
    ...
    Private Sub registraCotizacionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub registraCotizacionForm_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        colorearFila()
        colorear()
    End Sub
    ...
    Private Sub activarBoton()
        ...
        btnAnular.FlatStyle = FlatStyle.Standard
    ...
    Private Sub configurarColorControl()
        ...
        btnAnular.ForeColor = ForeColorButtom
    ...
    Private Sub btnAnular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnular.Click
        If BindingSource6.Position = -1 Then
            StatusBarClass.messageBarraEstado("  No existe cotizacion a RECHAZAR...")
            Exit Sub
        End If
        ...
        Dim resp As Short = MessageBox.Show("Esta segúro de RECHAZAR Cotizacion Nº " & BindingSource6.Item(BindingSource6.Position)(2), nomNegocio, MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If resp <> 6 Then
            Exit Sub
        End If
        ...
        Try
            ...
            For j As Short = 0 To BindingSource5.Count - 1
                'TDetalleCot
                comandoUpdate22(2, BindingSource5.Item(j)(0)) '2=Rechazado
                cmUpdateTable22.Transaction = myTrans
                If cmUpdateTable22.ExecuteNonQuery() < 1 Then
                    'deshace la transaccion
                    wait.Close()
    ...
    Private Sub btnSol_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSol.Click
        ...
        vCod3 = BindingSource6.Item(BindingSource6.Position)(12) 'Codigo de obra
