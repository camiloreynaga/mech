...
Public Class entradaSalidaAlmacen1Form
    ...
    Private Sub entradaSalidaAlmacen1Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select distinct codigo,nombre from VLugarUbiStoc TObra"
    ...
    Private Sub entradaSalidaAlmacen1Form_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    ...
    Private Function recuperarStock(ByVal codMat As Integer, ByVal codUbi As Integer) As Integer
    ...
    Private Sub comandoInsert11(ByVal saldo As Integer, ByVal codSuc As String)
    ...
    Private Sub btnDes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDes.Click
        ...
        Dim nroNota As Integer = recuperarNroNota(BindingSource4.Item(BindingSource4.Position)(19))  'codUbi
