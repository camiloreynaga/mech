...
Public Class MantFormaPagoForm
    'Instanciar una tabla de datos en memoria en ves de dataSet
    Dim dataTable1 As New DataTable()
    Dim BindingSource1 As New BindingSource

    Private Sub MantFormaPagoForm_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub

    Private Sub MantFormaPagoForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select codPag,forma from TFormaPago order by forma"
        ...
        Try
            ...
            lbTabla1.DisplayMember = "forma"
            lbTabla1.ValueMember = "codPag"
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        If BindingSource1.Find("forma", txtCam.Text.Trim()) >= 0 Then
            MessageBox.Show("Ya exíste forma de pago: " & txtCam.Text.Trim() & Chr(13) & "Cambie de nombre o cancele el proceso...", nomNegocio, Nothing, MessageBoxIcon.Information)
            txtCam.Focus()
            txtCam.SelectAll()
            Exit Sub
        End If
        ...
        Try
            ...
            BindingSource1.Position = BindingSource1.Find("forma", campo)
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        ...
        If vfCampo.ToUpper() <> txtCam.Text.ToUpper().Trim() Then
            ...
            End If
        End If
        Dim resp As String = MessageBox.Show("Esta segúro de actualizar forma de pago... ?" & Chr(13) & "Si actualiza todas sus dependencias heredaran" & Chr(13) & "este nombre...", nomNegocio, MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If resp <> 6 Then
            txtCam.Focus()
            Exit Sub
        End If
    ...
    Private Sub comandoDelete()
        ...
        cmDeleteTable.CommandText = "delete from TFormaPago where codPag=@cod"
