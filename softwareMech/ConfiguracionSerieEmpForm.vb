...
Public Class ConfiguracionSerieEmpForm
    ...
    Private Sub ConfiguracionSerieEmpForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sele = "select codSerS,serie,iniNroDoc,finNroDoc,'est'=case when estado=1 then 'Activo' else 'INACTIVO' end,descrip,codTipDE,estado from TSerieSede order by serie"   '1=Nota Venta
