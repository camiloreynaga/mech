...
Public Class MantMotivoGuiaForm
    'Instanciar una tabla de datos en memoria en ves de dataSet
    Dim dataTable1 As New DataTable()
    Dim BindingSource1 As New BindingSource

    Private Sub MantMotivoGuiaForm_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub

    Private Sub MantMotivoGuiaForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select codMotG,motivo from TMotivoGuia order by motivo"
        ...
        Try
            ...
            lbTabla1.DisplayMember = "motivo"
            lbTabla1.ValueMember = "codMotG"
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        If validaCampoVacioMinCaracNoNumer(txtCam.Text.Trim, 3) Then
            txtCam.errorProv()
            Exit Sub
        End If

        If BindingSource1.Find("motivo", txtCam.Text.Trim()) >= 0 Then
            MessageBox.Show("Ya exíste motivo: " & txtCam.Text.Trim() & Chr(13) & "Cambie de nombre o cancele el proceso...", nomNegocio, Nothing, MessageBoxIcon.Information)
            txtCam.Focus()
            txtCam.SelectAll()
            Exit Sub
        End If
        ...
        Try
            ...
            BindingSource1.Position = BindingSource1.Find("motivo", campo)
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        ...
        If vfCampo.ToUpper() <> txtCam.Text.ToUpper().Trim() Then
            ...
            End If
        End If
        Dim resp As String = MessageBox.Show("Esta segúro de actualizar motivo de producto... ?" & Chr(13) & "Si actualiza todas sus dependencias heredaran" & Chr(13) & "este nombre...", nomNegocio, MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If resp <> 6 Then
            txtCam.Focus()
            Exit Sub
        End If
    ...
    Private Function recuperarCount(ByVal cod As Integer) As Integer
        ...
        cmdCampo.CommandText = "select count(*) from TGuiaRemEmp where codMotG=" & cod
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        If lbTabla1.SelectedIndex = -1 Then
            ...
            Exit Sub
        End If
        If recuperarCount(lbTabla1.SelectedValue) > 0 Then
            StatusBarClass.messageBarraEstado("  PROCESO DENEGADO... MOTIVO TIENE GUIAS PROCESADAS...")
            Exit Sub
        End If
    ...
    Private Sub comandoInsert()
        ...
        cmInserTable.CommandText = "insert into TMotivoGuia(motivo) values(@cam)"
    ...
    Private Sub comandoUpdate()
        ...
        cmUpdateTable.CommandText = "update TMotivoGuia set motivo=@cam where codMotG=@cod"
    ...
    Private Sub comandoDelete()
        ...
        cmDeleteTable.CommandText = "delete from TMotivoGuia where codMotG=@cod"
