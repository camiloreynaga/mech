...
Public Class tesoreriaOrdenDesembolso2Form
    ...
    Private Sub tesoreriaOrdenDesembolso2Form_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub

    Private Sub tesoreriaOrdenDesembolso2Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select idOP,fecDes,serie,nro,simbolo,monto,montoDet,montoDif,nombre,estApro,nom,datoReq,ruc,razon,banco,nroCta,nroDet,hist,estDesem,codPersDes,estado,codMon,nomSol,codPersSol,codSerO,vanCaja from VOrdenDesemTesoreria where codSerO>@codSer1 or codSerO=@codSer2" 'order by idOP
        ...
        sele = "select codPagD,fecPago,mesano,tipoP,banco,nroP,simbolo,montoPago,montoD,tipoClasif,clasificacion,egreso,pagoDet,codTipP,codMon,idOP,idCue,codCla,codTipCla,vanEgreso,idSesM from VPagoDesemTesoreria where idOP=@idOP"
        ...
        sele = "select distinct idCue,banmon,banco,nroCue,simbolo,moneda,codBan,codMon from VBancoCuenta1 order by banco,simbolo"
        ...
        sele = "select distinct codCla,clasificacion,idTM from VSubClasificacionEgreso TClasificacion"
        crearDataAdapterTable(daTabla4, sele)

        sele = "select codTipCla,tipoClasif,codCla from VSubClasificacionEgreso TTipoClasif"
        ...
        Try
            ...
            daTabla3.Fill(dsAlmacen, "VBancoCuenta1")
            daTabla5.Fill(dsAlmacen, "TSerieOrden")
            daTSesion.Fill(dsAlmacen, "VSesionMes")
            daTabla4.Fill(dsAlmacen, "TClasificacion")
            daTabla6.Fill(dsAlmacen, "TTipoClasif")
            ...
            BindingSource4.DataMember = "VBancoCuenta1"
            cbCue.DataSource = BindingSource4
            cbCue.DisplayMember = "banmon"
            cbCue.ValueMember = "idCue"

            BindingSource3.DataSource = BindingSource4
            BindingSource3.DataMember = "Relacion2"
            cbMod.DataSource = BindingSource3
            cbMod.DisplayMember = "medioP"
            cbMod.ValueMember = "codMP"

            BindingSource5.DataSource = dsAlmacen
            BindingSource5.DataMember = "TClasificacion"
            cbClas.DataSource = BindingSource5
            cbClas.DisplayMember = "clasificacion"
            cbClas.ValueMember = "codCla"

            BindingSource6.DataSource = BindingSource5
            BindingSource6.DataMember = "Relacion1"
            cbSubClas.DataSource = BindingSource6
            cbSubClas.DisplayMember = "tipoClasif"
            cbSubClas.ValueMember = "codTipCla"
            ...
            BindingSource7.DataMember = "VSesionMes"
            cbMes.DataSource = BindingSource7
            ...
            rb1.Checked = True
            rb3.Checked = True
            BindingSource7.MoveLast() 'ultimo mes abierto
    ...
    Private Sub tesoreriaOrdenDesembolso2Form_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        colorearFila()
        calcularTotales()
    ...
    Private Sub AgregarRelacion()
        ...
        Dim relation1 As New DataRelation("Relacion1", dsAlmacen.Tables("TClasificacion").Columns("codCla"), dsAlmacen.Tables("TTipoClasif").Columns("codCla"))
        dsAlmacen.Relations.Add(relation1)
        'agregando una relacion entre la tablaS
        Dim relation2 As New DataRelation("Relacion2", dsAlmacen.Tables("VBancoCuenta1").Columns("idCue"), dsAlmacen.Tables("TMedioPago").Columns("idCue"))
    ...
    Private Sub ModificarColumnasDGV()
        ...
        With dgTabla2
            ...
            .Columns(1).HeaderText = "Fecha"
            .Columns(2).Width = 110
            .Columns(2).HeaderText = "Periodo"
            .Columns(3).Width = 200
            .Columns(3).HeaderText = "Medio Pago"
            .Columns(4).Width = 70
            .Columns(4).HeaderText = "Banco"
            .Columns(5).Width = 100
            .Columns(5).HeaderText = "Nº"
            ...
            .Columns(9).HeaderText = "SubClasificación"
            .Columns(9).Width = 100
            .Columns(10).HeaderText = "Clasificación"
            .Columns(10).Width = 90
            .Columns(11).Width = 70
            .Columns(11).HeaderText = "Movim."
            .Columns(12).HeaderText = "Descripción"
    ...
    Private Sub configurarColorControl()
        ...
        GB1.ForeColor = ForeColorLabel
        GB2.ForeColor = ForeColorLabel
        GB3.ForeColor = ForeColorLabel
        GB4.ForeColor = ForeColorLabel
    ...
    Private Sub desActivarText()
        ...
        cbClas.Enabled = False
        cbSubClas.Enabled = False
    ...
    Private Function recuperarCodCla(ByVal cod As Integer) As Integer
        Dim cmdCampo As SqlCommand = New SqlCommand
        cmdCampo.CommandType = CommandType.Text
        cmdCampo.CommandText = "select isnull(max(codCla),0) from TTipoClasif where estado=1 and codTipCla=" & cod
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        If vfNuevo2 = "nuevo" Then
            ...
            Dim codCla As Integer = recuperarCodCla(BindingSource1.Item(BindingSource1.Position)(25))
            If codCla = 0 Then 'No existe clasificacion
                cbClas.SelectedIndex = 0
                cbSubClas.SelectedIndex = 0
            Else    'ubicar en clasificacion
                cbClas.SelectedValue = codCla
                cbSubClas.SelectedValue = BindingSource1.Item(BindingSource1.Position)(25) 'codTipCla
            End If
    ...
    Private Sub comandoInsert()
        ...
        cmInserTable.Parameters.Add("@codC", SqlDbType.Int, 0).Value = 1  'obsoleto en blanco
        ...
        cmInserTable.Parameters.Add("@codTC", SqlDbType.Int, 0).Value = cbSubClas.SelectedValue
        If rb3.Checked Then
            cmInserTable.Parameters.Add("@vanE", SqlDbType.Int, 0).Value = 0 '0=egreso   1=Tranferencia
        Else
            cmInserTable.Parameters.Add("@vanE", SqlDbType.Int, 0).Value = 1 '0=egreso   1=Tranferencia
        End If
        cmInserTable.Parameters.Add("@idS", SqlDbType.Int, 0).Value = cbMes.SelectedValue
    ...
    Private Sub ToolStripButton5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton5.Click
        ...
        If total <> CDbl(BindingSource1.Item(BindingSource1.Position)(5)) Then
            ...
            'Exit Sub
            msge = "Montos Diferentes en Transacción [" & Format(total, "0,0.00") & "<>" & BindingSource1.Item(BindingSource1.Position)(5) & "]"
        End If

        Dim resp As String = MessageBox.Show(msge & Chr(13) & "Está seguro de CERRAR ORDEN de DESEMBOLSO Nº " & BindingSource1.Item(BindingSource1.Position)(3) & Chr(13) & " Si cierra no podra deshacer proceso...", nomNegocio, MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If resp <> 6 Then
            Exit Sub
        End If
    ...
    Private Sub enlazarText()
        If BindingSource2.Count = 0 Then
            'desEnlazarText()
        Else
            cbMes.SelectedValue = BindingSource2.Item(BindingSource2.Position)(20)
            date1.Value = BindingSource2.Item(BindingSource2.Position)(1)
            cbMod.SelectedValue = BindingSource2.Item(BindingSource2.Position)(13)
            cbCue.SelectedValue = BindingSource2.Item(BindingSource2.Position)(16)
            txtNro.Text = BindingSource2.Item(BindingSource2.Position)(5)

            cbClas.SelectedValue = BindingSource2.Item(BindingSource2.Position)(13)

            Dim codCla As Integer = recuperarCodCla(BindingSource2.Item(BindingSource2.Position)(18))
            If codCla = 0 Then 'No existe clasificacion
                cbClas.SelectedIndex = 0
                cbSubClas.SelectedIndex = 0
            Else    'ubicar en clasificacion
                cbClas.SelectedValue = codCla
                cbSubClas.SelectedValue = BindingSource2.Item(BindingSource2.Position)(18) 'codTipCla
            End If

            txtDes.Text = BindingSource2.Item(BindingSource2.Position)(12)
            cbMon.SelectedValue = BindingSource2.Item(BindingSource2.Position)(14)
            ...
            Else 'detraccion monto
                txtMon.Text = BindingSource2.Item(BindingSource2.Position)(8)
                CheckBox1.Checked = True
            End If

            If BindingSource2.Item(BindingSource2.Position)(19) = 0 Then  'Egreso
                rb3.Checked = True
            Else  'NO egreso
                rb4.Checked = True
            End If
    ...
    Private Sub comandoUpdate()
        ...
        cmUpdateTable.CommandText = "update TPagoDesembolso set fecPago=@fec,codTipP=@codT,nroP=@nro,pagoDet=@det,codCla=@codC,codMon=@codM,montoPago=@monto,montoD=@montoD,idCue=@idC,codTipCla=@codTC,vanEgreso=@vanE,idSesM=@idS where codPagD=@cod"
        ...
        cmUpdateTable.Parameters.Add("@codC", SqlDbType.Int, 0).Value = 1  'obsoleto en blanco
        ...
        cmUpdateTable.Parameters.Add("@codTC", SqlDbType.Int, 0).Value = cbSubClas.SelectedValue
        If rb3.Checked Then
            cmUpdateTable.Parameters.Add("@vanE", SqlDbType.Int, 0).Value = 0 '0=egreso   1=Tranferencia
        Else
            cmUpdateTable.Parameters.Add("@vanE", SqlDbType.Int, 0).Value = 1 '0=egreso   1=Tranferencia
        End If
        cmUpdateTable.Parameters.Add("@idS", SqlDbType.Int, 0).Value = cbMes.SelectedValue
