...
Public Class CrGastosDia2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "softwareMech.CrGastosDia2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrGastosDia2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrGastosDia2 = New CrGastosDia2
        rpt.Site = Me.Site
        Return rpt
    End Function
