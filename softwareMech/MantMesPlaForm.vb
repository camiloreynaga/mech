...
Public Class MantMesPlaForm
    Dim BindingSource1 As New BindingSource

    Private Sub MantMesPlaForm_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub

    Private Sub MantMesPlaForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select idSesM,mes,ano,estado,idMes,estado1 from VMesPlan order by idSesM"
        crearDataAdapterTable(daTabla1, sele)
        'daTabla1.SelectCommand.Parameters.Add("@cod", SqlDbType.VarChar, 10).Value = vSCodigo

        sele = "select idMes,mes from TMesPla order by idMes"
        ...
        Try
            ...
            daTabla1.Fill(dsAlmacen, "VMesPlan")
            daTabla2.Fill(dsAlmacen, "TMesPla")

            BindingSource1.DataSource = dsAlmacen
            BindingSource1.DataMember = "VMesPlan"
            ...
            lbMes.DisplayMember = "TMesPla.mes"
    ...
    Public Function recuperarCount(ByVal idMes As Short, ByVal ano As Integer) As Short
        ...
        cmdCampo.CommandText = "select count(*) from TSesionMesPla where idMes=" & idMes & " and ano=" & ano
    ...
    Private Sub comandoUpdate13()
        ...
        cmUpdateTable13.CommandText = "update TSesionMesPla set estado=3 where estado=2"
    ...
    Private Sub comandoUpdate14()
        ...
        cmUpdateTable14.CommandText = "update TSesionMesPla set estado=2 where estado=1"
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        Else   ' guardar
            If recuperarCount(lbMes.SelectedValue, lbAno.Text.Trim()) > 0 Then
                MessageBox.Show("Ya exíste Mes => " & lbMes.Text.Trim() & " - " & lbAno.Text.Trim(), nomNegocio, Nothing, MessageBoxIcon.Information)
                Exit Sub
            End If
            ...
            Try
                ...
                dsAlmacen.Tables("VMesPlan").Clear()
                daTabla1.Fill(dsAlmacen, "VMesPlan")
    ...
    Private Sub comandoInsert()
        ...
        cmInserTable.CommandText = "insert TSesionMesPla(idMes,ano,estado) values(@idM,@ano,@est)"
    ...
    Private Sub comandoUpdate()
        ...
        cmUpdateTable.CommandText = "update TSesionMesPla set idMes=@idM,ano=@ano where idSesM=@cod"
    ...
    Private Sub comandoDelete()
        ...
        cmDeleteTable.CommandText = "delete from TSesionMesPla where idSesM=@cod"
