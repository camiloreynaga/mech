...
Public Class MantCargo1Form
    'Instanciar una tabla de datos en memoria en ves de dataSet
    Dim dataTable1 As New DataTable()
    Dim BindingSource1 As New BindingSource
    Private Sub MantCargo1Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select codCar,cargo from TCargoPers order by cargo"
    ...
    Private Sub MantCargo1Form_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Leave
        Me.Close()
    End Sub
    ...
    Private Function recuperarCount1(ByVal cod As Integer) As Integer
        ...
        cmdCampo.CommandText = "select count(*) from TPersona where codCar=" & cod
    ...
    Private Sub comandoInsert()
        ...
        cmInserTable.CommandText = "insert into TCargoPers(cargo) values(@car)"
        cmInserTable.Connection = Cn
        cmInserTable.Parameters.Add("@car", SqlDbType.VarChar, 30).Value = txtCar.Text.Trim()
    End Sub
    ...
    Private Sub comandoUpdate()
        ...
        cmUpdateTable.CommandText = "update TCargoPers set cargo=@car where codCar=@cod"
        cmUpdateTable.Connection = Cn
        cmUpdateTable.Parameters.Add("@car", SqlDbType.VarChar, 30).Value = txtCar.Text.Trim()
    ...
    Private Sub comandoDelete()
        ...
        cmDeleteTable.CommandText = "delete from TCargoPers where codCar=@cod"
