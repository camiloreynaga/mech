...
Public Class MantTipoMatForm
    'Instanciar una tabla de datos en memoria en ves de dataSet
    Dim dataTable1 As New DataTable()
    Dim BindingSource1 As New BindingSource

    Private Sub MantTipoMatForm_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        Me.Close()
    End Sub

    Private Sub MantTipoMatForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sele As String = "select codTipM,tipoM from TTipoMat order by tipoM"
        ...
        Try
            ...
            lbTabla1.DisplayMember = "tipoM"
            lbTabla1.ValueMember = "codTipM"
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        If BindingSource1.Find("tipoM", txtCam.Text.Trim()) >= 0 Then
            MessageBox.Show("Ya exíste tipo de insumos: " & txtCam.Text.Trim() & Chr(13) & "Cambie de nombre o cancele el proceso...", nomNegocio, Nothing, MessageBoxIcon.Information)
            txtCam.Focus()
            txtCam.SelectAll()
            Exit Sub
        End If
        ...
        Try
            ...
            BindingSource1.Position = BindingSource1.Find("tipoM", campo)
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        ...
        If vfCampo.ToUpper() <> txtCam.Text.ToUpper().Trim() Then
            ...
            End If
        End If
        Dim resp As String = MessageBox.Show("Esta segúro de actualizar tipo de insumos... ?" & Chr(13) & "Si actualiza todas sus dependencias heredaran" & Chr(13) & "este nombre...", nomNegocio, MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If resp <> 6 Then
            txtCam.Focus()
            Exit Sub
        End If
    ...
    Private Function recuperarCount1(ByVal cod As Integer) As Integer
        ...
        cmdCampo.CommandText = "select count(*) from TMaterial where codTipM=" & cod
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If recuperarCount1(lbTabla1.SelectedValue) > 0 Then
            StatusBarClass.messageBarraEstado(" Proceso denegado, tipo de insumo tiene insumos...")
            Exit Sub
        End If
    ...
    Private Sub comandoInsert()
        ...
        cmInserTable.CommandText = "insert into TTipoMat(tipoM) values(@cam)"
    ...
    Private Sub comandoUpdate()
        ...
        cmUpdateTable.CommandText = "update TTipoMat set tipoM=@cam where codTipM=@cod"
    ...
    Private Sub comandoDelete()
        ...
        cmDeleteTable.CommandText = "delete from TTipoMat where codTipM=@cod"
