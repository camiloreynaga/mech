...
Public Class CrGastosDia2_Obra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "softwareMech.CrGastosDia2_Obra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrGastosDia2_Obra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrGastosDia2_Obra = New CrGastosDia2_Obra
        rpt.Site = Me.Site
        Return rpt
    End Function
