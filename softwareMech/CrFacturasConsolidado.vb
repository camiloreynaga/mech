...
Public Class CrFacturasConsolidado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrFacturasConsolidado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "softwareMech.CrFacturasConsolidado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrFacturasConsolidado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrFacturasConsolidado = New CrFacturasConsolidado
        rpt.Site = Me.Site
        Return rpt
    End Function
