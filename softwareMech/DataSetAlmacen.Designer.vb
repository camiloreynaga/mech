...
Partial Public Class DataSetAlmacen
    ...
    Partial Public Class VOrdenDesembolsoImprimirDataTable
        ...
        Public Overloads Function AddVOrdenDesembolsoImprimirRow( _
                    ...
                    ByVal montoD As Decimal) As VOrdenDesembolsoImprimirRow
    ...
    Partial Public Class VGastosPorDiaDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddVGastosPorDiaRow(ByVal fecPago As Date, ByVal ruc As String, ByVal razon As String, ByVal simbolo As String, ByVal montoPago As Decimal, ByVal montoD As Decimal, ByVal banco As String, ByVal nroCue As String, ByVal nroOperacion As String, ByVal nroDes As String, ByVal codBan As Integer) As VGastosPorDiaRow
            Dim rowVGastosPorDiaRow As VGastosPorDiaRow = CType(Me.NewRow,VGastosPorDiaRow)
            Dim columnValuesArray() As Object = New Object() {fecPago, ruc, razon, simbolo, montoPago, montoD, banco, nroCue, nroOperacion, nroDes, codBan}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function FindBycodBan(ByVal codBan As Integer) As VGastosPorDiaRow
            Return CType(Me.Rows.Find(New Object() {codBan}),VGastosPorDiaRow)
        End Function
...
Namespace DataSetAlmacenTableAdapters
    ...
    Partial Public Class VOrdenDesembolsoImprimirTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select idOP,nro,fecDes,codMon,moneda,simbolo,monto,montoDet,montoDif,estado,codig"& _ 
                ...
                ",gereEst,tesoEst,contaEst,nroP,clasif,montoD from VOrdenDesembolsoImprimir where"& _ 
                " idOP=@id"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
    ...
    Partial Public Class VGastosPorDiaTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "select fecPago,ruc,razon,simbolo,montoPago,montoD,banco,nroCue,nroOperacion,(seri"& _ 
                "e +'-'+cast(nroDes as varchar)) nroDes,codBan from VGastosPorDia order by codBan"& _ 
                " asc"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSetAlmacen.VGastosPorDiaDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As DataSetAlmacen.VGastosPorDiaDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
