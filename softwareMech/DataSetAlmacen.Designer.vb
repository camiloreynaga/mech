...
Partial Public Class DataSetAlmacen
    ...
    Partial Public Class VMovimientoCajaDataTable
        ...
        Public Overloads Function AddVMovimientoCajaRow( _
                    ...
                    ByVal codPers As Integer,  _
                    ByVal codPagD As Integer,  _
                    ByVal codCaj As Integer) As VMovimientoCajaRow
            Dim rowVMovimientoCajaRow As VMovimientoCajaRow = CType(Me.NewRow,VMovimientoCajaRow)
            Dim columnValuesArray() As Object = New Object() {nroMC, movimiento, fecha, nroOrd, simbolo, montoEnt, nroSol, simbolo1, montoSal, saldoMov, tipoP, nroP, nomPers, descrip, nombre, nomCaja, codDia, codTM, codigo, codCC, idOP, codUsu, codMon, codSC, codPers, codPagD, codCaj}
    ...
    Partial Public Class VMovimientoCajaTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select nroMC,movimiento,fecha,nroOrd,simbolo,montoEnt,nroSol,simbolo,montoSal,sal"& _ 
                "doMov,tipoP,nroP,nomPers,descrip,nombre,nomCaja,codDia,codTM,codigo,codCC,idOP,c"& _ 
                "odUsu,codMon,codSC,codPers,codPagD,codCaj from VMovimientoCaja where codDia>=@co"& _ 
                "dDia1 and codDia<=@codDia2 and codCaj=@codCC"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
    ...
    Partial Public Class VDetSolCajaCuentaImprimirTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select codDetSol,nomSede,nomObra,nomSol,tipoM,montoSol,imprevisto,salAnt,salAct,c"& _ 
                ...
                "Ren,compRen,ingreso,obsSol from VDetSolCajaCuentaImprimir where codSC=@cod"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@cod", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "codSC", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
