...
(TPE.nombre + TPE.apellido) as Personal, TGR.codPers 
...
as
select TDEGR.codDGE, TLU.nombre Obra,  TDEGR.codigo, TDEGR.cant, TDEGR.descrip, TDEGR.unidad, TDEGR.peso, TDEGR.codGuiaE,
